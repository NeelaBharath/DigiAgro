...
async function getAllFarmers() {
  try {
      const contract = await StructStorage.deployed();
      const farmers = await contract.getAllFarmers.call();
      ...
      for (let i = 0; i < farmers.length; i++) {
          ...
          listItem.innerHTML = `
              <td>${web3.toAscii(farmer[0])}</td>
              <td>${web3.toAscii(farmer[1])}</td>
              <td>${web3.toAscii(farmer[2])}</td>
              <td>${web3.toAscii(farmer[3])}</td>
              <td>${farmer[4]}</td>
              <td>${farmer[5]}</td>
              <td>${farmer[6]}</td>
          `;
